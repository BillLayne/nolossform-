// ============================================
// NoLossForm.com - Multi-Tenant SaaS Platform
// VERSION: 3.1 - FIXED PDF & FIELD HANDLING
...
function testScript() {
  const testData = {
    ...
    state: 'NC',
    zipCode: '28621',
    agencyName: 'Test Agency ABC',
    agencyAddress: '123 Agency St, City ST 12345',
  ...
  console.log('Check PDF URL:', result.pdfUrl);
  console.log('Check your Google Sheets and Drive for results');
}
...
function debugLastSubmission() {
  const sheet = SpreadsheetApp.openById(CONFIG.SPREADSHEET_ID).getSheetByName('Submissions');
  const lastRow = sheet.getLastRow();
  const data = sheet.getRange(lastRow, 1, 1, sheet.getLastColumn()).getValues()[0];

  console.log('=== LAST SUBMISSION DEBUG ===');
  console.log('Timestamp:', data[0]);
  console.log('Confirmation:', data[1]);
  console.log('Customer Name:', data[2]);
  console.log('Policy Number:', data[3]);
  console.log('Agency Name:', data[20]);
  console.log('Agency Email:', data[21]);
  console.log('Has Signature:', data[19]);
  console.log('===========================');
}