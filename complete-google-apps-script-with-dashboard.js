...
// VERSION: 4.0 - WITH DASHBOARD DATA FUNCTIONS
...
// ============================================
// ENHANCED PDF WITH CUSTOMER ADDRESS & TIME SYNC
// ============================================
...
function generateCompletePDF(data, confirmationNumber) {
  try {
    ...
    // ===== INFO TABLE WITH CUSTOMER ADDRESS ADDED =====
    ...
    row5.appendTableCell('AMOUNT:').getChild(0).asParagraph().setBold(true).setFontSize(8);
    row5.appendTableCell(data.amountPaid || 'N/A').getChild(0).asParagraph().setFontSize(8);
    ...
    if (data.additionalComments) {
      ...
      row6.appendTableCell(data.additionalComments).getChild(0).asParagraph().setFontSize(8);
...
function quickTest() {
  ...
  console.log('Version: 4.0 with Dashboard');
  return 'Configuration verified! Version 4.0';
}
